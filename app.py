...
comarcas_dict = {
    "ALTO_DEBA": pd.read_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_pueblos/ALTO_DEBA.csv'),
    "BAJO_DEBA": pd.read_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_pueblos/BAJO_DEBA.csv'),
    "BAJO_BIDASOA": pd.read_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_pueblos/BAJO_BIDASOA.csv'),
    "DONOSTIALDEA": pd.read_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_pueblos/DONOSTIALDEA.csv'),
    "GOIERRI": pd.read_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_pueblos/GOIERRI.csv'),
    "TOLOSALDEA": pd.read_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_pueblos/TOLOSALDEA.csv'),
    "UROLA KOSTA": pd.read_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_pueblos/UROLA_KOSTA.csv'),
}

roads_gdf = gpd.read_file('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/ERREPIDEAK_CARRETERAS/ERREPIDEAK_CARRETERAS.shp')
...
with open('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/roads.json', "w") as json_file:
    json.dump(roads_geojson, json_file, indent=4)

gdf = gpd.read_file('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/comarcas_gipuzkoa_monoparte/comarcas_gipuzkoa_monoparte.shp')
...
gdf["sankey"] = gdf["COMARCA"].map(comarc_to_csv).fillna("C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs/comarcas_sankey.csv")
gdf = gdf.to_crs(epsg=4326)
geojson_data = json.loads(gdf.to_json())

# default_sankey_file = "C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs/comarcas_sankey.csv"
data_global = pd.read_csv("C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/data_global.csv")
...
app.layout = html.Div([
    ...
    html.Div([
        dl.Map(center=[43.14, -1.6], zoom=11, children=[
    ...
    html.Button([
        ...
        'position': 'absolute', 'top': '675px', 'left': '10%', 'transform': 'translateX(-50%)',
    ...
    html.Div([
        dcc.Graph(id="sankey-graph", style={'width': '460px', 'height': '400px'})
    ], style={
        'position': 'absolute', 'bottom': '0px', 'left': '82%', 'transform': 'translateX(-50%)',
        'padding': '20px', 'borderRadius': '10px',
        'zIndex': '10', 'boxShadow': '2px 2px 10px rgba(0,0,0,0)'
    }),

    html.Div([
        dcc.Graph(id="treemap-graph", style={'width': '100%', 'height': '100%', 'backgroundColor': 'rgba(0,0,0,0)'})
    ], style={
        'position': 'absolute', 'bottom': '300px', 'left': '82%', 'transform': 'translateX(-50%)',
        'padding': '20px', 'borderRadius': '10px',
        'zIndex': '10', 'boxShadow': 'none', 'width': '460px',  # Keep this for outer div
        'backgroundColor': 'rgba(0,0,0,0)',
        'height': '300px',  # Keep this for outer div
        'minWidth': '300px',  # Ensure it doesn't shrink too much
        'minHeight': '250px',  # Ensure it has enough space
        'maxWidth': '600px',  # Prevent it from getting too large
        'maxHeight': '300px',  # Prevent it from getting too large
    ...
    html.Div([
        dcc.Graph(id="radar-plot", style={'width': '500px', 'height': '300px'})
    ], style={
    ...
    html.Img(
        ...
        style={
            ...
            'width': '300px', 'height': 'auto', 'zIndex': '10'
        }
    ), 
    ...
    html.Div([
        html.H2("Designed by yourself:", style={'textAlign': 'center', 'fontWeight': 'bold', 'marginTop': '15px', 'fontFamily': 'Arial', 'fontSize': '30px'}),
    ], style={
        'position': 'absolute', 'top': '45px', 'right': '410px',
        'color': 'white',  # Styling
        'padding': '10px',
        'width': '430px', 'textAlign': 'center',
        'zIndex': '10',
    ...
    style={
        'position': 'absolute', 'top': '110px', 'right': '510px',
        'color': 'white',  # Styling
        'padding': '10px',
        'width': '430px', 'textAlign': 'center',
        'zIndex': '10',
    ...
    html.Div([
        ...
        'position': 'absolute', 'top': '110px', 'right': '390px',
        'color': 'white',  # Styling
        'padding': '10px',
        'width': '430px', 'textAlign': 'center',
        'zIndex': '10',
    ...
    html.Div([
        ...
        'position': 'absolute', 'top': '215px', 'right': '370px',
        'color': 'white',  # Styling
        'padding': '10px',
        'width': '430px', 'textAlign': 'center',
        'zIndex': '10',
    ...
    html.Div([
        ...
        'position': 'absolute', 'top': '215px', 'right': '70px',
        'color': 'white',  # Styling
        'padding': '10px',
        'width': '430px', 'textAlign': 'center',
        'zIndex': '10',
    ...
    html.Div([
        ...
        'position': 'absolute', 'top': '110px', 'right': '-85px',
        'color': 'white',  # Styling
        'padding': '10px',
        'width': '430px', 'textAlign': 'center',
        'zIndex': '10',
    ...
    html.Div([
        ...
        'position': 'absolute', 'top': '215px', 'right': '-100px',
        'color': 'white',  # Styling
        'padding': '10px',
        'width': '430px', 'textAlign': 'center',
        'zIndex': '10',
    ...
    html.Div([
        ...
        'top': '180px',  # Set the vertical position on the page
...
def generate_radar_chart(radar_data):
    ...
    fig.update_layout(
        ...
        legend=dict(
            ...
            y=-0.3,  # Moves legend to the bottom
            xanchor="right",
            yanchor="bottom",
        ),
        # paper_bgcolor='black',
...
def update_sankey(click_data, n_clicks, current_fig, drop_simbiosis, drop_carpool, drop_ev, drop_30, drop_ond):
    ...
    comarcas_sankey.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/comarcas_sankey.csv')
    ...
    tolosaldea_dataset.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/tolosaldea_sankey.csv')
    ...
    bidasoa_dataset.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/bidasoa_sankey.csv')
    ...
    urola_dataset.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/urola_kosta_sankey.csv')
    ...
    debagoiena_dataset.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/debagoiena_sankey.csv')
    ...
    goierri_dataset.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/goierri_sankey.csv')
    ...
    donostialdea_dataset.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/donostialdea_sankey.csv')
    ...
    debabarrena_dataset.to_csv('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/debabarrena_sankey.csv')
    ...
    #     return [
    #         generate_sankey_chart("C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/comarcas_sankey.csv", "Trips in GIPUZKOA"),
    #         df_json
    #     ]
    ...
    #     return [
    #         current_fig if current_fig else generate_sankey_chart("C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/comarcas_sankey.csv", "Trips in GIPUZKOA"),
    #         df_json
    #     ]
    ...
    #     if sankey_file:
    #         sankey_path = f"C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/sankey_graphs_2/{sankey_file}"
    #         return [
...
def update_treemap(df_json):
    ...
    # fig = px.treemap(
    #     df,
    #     path=['cat'],  # Grouping based on 'cat' column
    #     values="viajes_km",  # Size of the boxes
    ...
    # fig.update_layout(
    #     title=dict(
    #         text="Trip Distribution by Category",
...
def update_roads(drop_simbiosis, drop_carpool, drop_life, drop_ondemand):
    ...
    if drop_simbiosis == "not_selected_simbiosis":
        ...
        with open('C:/Users/iazcarateu/Desktop/CSL@Gipuzkoa/regional_mobility/others/roads_2.json', "w") as json_file:
